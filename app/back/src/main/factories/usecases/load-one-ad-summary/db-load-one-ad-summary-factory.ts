...
import { DbLoadOneAdSummary } from '../../../../data/usecases/load-one-ad-summary/db-load-one-ad-summary'
...
export const makeDbLoadOneAdSummary = (pool: Pool): LoadOneAdSummary => {
  ...
  return new DbLoadOneAdSummary(loadCampaignsRepository, getTaboolaId, loadOptimizationDataRepository, getExternalAdInfo)
}
